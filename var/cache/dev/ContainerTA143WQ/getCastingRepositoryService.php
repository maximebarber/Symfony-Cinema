...
// Returns the private 'App\Repository\CastingRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CastingRepository.php';

return $this->privates['App\Repository\CastingRepository'] = new \App\Repository\CastingRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
